        ...
        <div className='flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center'>
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>Lorem ipsum dolor sit amet <br /> consectetur adi</p>
                </div>
            </div>
            ...
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>Lorem ipsum dolor  ametloremasssssss <br /> consectetur adi</p>
                </div>
            </div>
